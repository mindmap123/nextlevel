  ...
  return (
    <main className="min-h-screen bg-night">
      <div className="container mx-auto px-5 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-cream mb-8">Conditions Générales de Vente</h1>

        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">1. Objet</h2>
            ...
            <ul className="list-disc pl-6 text-ash space-y-2 mt-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">2. Acceptation des CGV</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">3. Devis et commande</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">4. Prix et modalités de paiement</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">5. Délais de réalisation</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">6. Obligations du Client</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">7. Obligations du Prestataire</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">8. Modifications et révisions</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">9. Livraison et recette</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">10. Garantie et maintenance</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">11. Propriété intellectuelle</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">12. Résiliation</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">13. Responsabilité</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">14. Confidentialité</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">15. Force majeure</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">16. Droit applicable et litiges</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">17. Médiation</h2>
            <p className="text-ash leading-relaxed">
