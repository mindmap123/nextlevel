  ...
  return (
    <main className="min-h-screen bg-night">
      <div className="container mx-auto px-5 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-cream mb-8">Mentions Légales</h1>

        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">1. Hébergement</h2>
            <p className="text-ash leading-relaxed">
              Le site est hébergé par :<br />
              <strong>Vercel Inc.</strong><br />
              340 S Lemon Ave #4133<br />
              Walnut, CA 91789, USA<br />
              Site web : <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">vercel.com</a>
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">2. Propriété intellectuelle</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">3. Données personnelles</h2>
            <p className="text-ash leading-relaxed">
            ...
            <p className="text-ash leading-relaxed mt-4">
              Pour plus d'informations, consultez notre <Link href="/politique-confidentialite" className="text-accent hover:underline">Politique de Confidentialité</Link>.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">5. Limitation de responsabilité</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">6. Droit applicable</h2>
            <p className="text-ash leading-relaxed">
