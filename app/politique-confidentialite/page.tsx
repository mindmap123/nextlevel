  ...
  return (
    <main className="min-h-screen bg-night">
      <div className="container mx-auto px-5 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-cream mb-8">Politique de Confidentialité</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">2. Collecte de données</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">3. Communication via WhatsApp</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">4. Cookies</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">5. Hébergement et logs serveur</h2>
            <p className="text-ash leading-relaxed">
            ...
            <p className="text-ash leading-relaxed mt-4">
              Ces données sont conservées temporairement à des fins de sécurité et de performance. Pour plus d'informations, consultez la <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">politique de confidentialité de Vercel</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">6. Vos droits (RGPD)</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">7. Sécurité</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">8. Liens externes</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">9. Modifications</h2>
            <p className="text-ash leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cream mb-4">10. Contact</h2>
            <p className="text-ash leading-relaxed">
